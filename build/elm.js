...
var _user$project$Knight_UV$defences = {base: 125 / 2, $class: 142 / 2, special: 150 / 2, plate: 200 / 2, ancient: 300 / 2, uvLow: (_user$project$Knight_UV$uvMax * 1) / 4, uvMed: (_user$project$Knight_UV$uvMax * 2) / 4, uvHigh: (_user$project$Knight_UV$uvMax * 3) / 4, uvMax: _user$project$Knight_UV$uvMax};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Knight.UV.BonusStrength":{"args":[],"tags":{"Low":[],"NegVeryHigh":[],"NegUltra":[],"Medium":[],"Maximum":[],"VeryHigh":[],"Ultra":[],"NegMaximum":[],"NegHigh":[],"NegLow":[],"High":[],"NegMedium":[]}},"Knight.Status.Status":{"args":[],"tags":{"Stun":[],"Sleep":[],"Shock":[],"Poison":[],"Curse":[],"Fire":[],"Freeze":[],"Random":[],"Deathmark":[]}},"Knight.UV.DamageType":{"args":[],"tags":{"Piercing":[],"Normal":[],"Shadow":[],"Elemental":[]}},"Knight.Types.StatusChance":{"args":[],"tags":{"Slight":[],"Fair":[],"Good":[],"Certain":[]}},"Events.Side":{"args":[],"tags":{"Left":[],"Right":[]}},"Knight.Types.StatusStrength":{"args":[],"tags":{"Minor":[],"Strong":[],"Ultimate":[],"Moderate":[]}},"Events.Event":{"args":[],"tags":{"Recovery":["Knight.Status.Status"],"Attack":["( String, Knight.Types.Stage )"],"Infliction":["( Knight.Status.Status, Knight.Types.StatusStrength )"]}},"Knight.Types.Stage":{"args":[],"tags":{"Basic":[],"Shot":[],"Heavy":[],"Special":[],"Charge":[]}},"Knight.Types.WeaponType":{"args":[],"tags":{"Bomb":[],"Gun":[],"Sword":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Knight.UV.Bonus":{"args":[],"tags":{"BombDmg":[],"GunASI":[],"Construct":[],"SwordDmg":[],"SwordASI":[],"GunCTR":[],"Beast":[],"BombCTR":[],"Undead":[],"MSI":[],"GunDmg":[],"CTR":[],"SwordCTR":[],"Fiend":[],"ASI":[],"Gremlin":[],"Slime":[],"Dmg":[]}},"Main.Msg":{"args":[],"tags":{"SetState":["Main.State"],"EquipRight":["Knight.Knight"],"Loadouts":["List ( String, String )"],"SetEvents":["List ( Events.Side, Events.Event )"],"EquipLeft":["Knight.Knight"],"SaveLoadout":["( String, String )"]}},"Knight.UV.UV":{"args":[],"tags":{"StatusUV":["( Knight.Status.Status, Knight.UV.BonusStrength )"],"Hearts":["Int"],"WeaponUV":["( Knight.UV.Bonus, Knight.UV.BonusStrength )"],"DefenceUV":["( Knight.UV.DamageType, Knight.UV.BonusStrength )"]}},"Main.State":{"args":[],"tags":{"You":[],"Vs":[],"Opponent":[]}}},"aliases":{"Knight.WeaponEquip":{"args":[],"type":"{ piece : Knight.Types.Weapon, uvs : List Knight.UV.UV }"},"Knight.Types.Trinket":{"args":[],"type":"{ id : String, name : String, effects : List Knight.UV.UV }"},"Knight.ArmourEquip":{"args":[],"type":"{ piece : Knight.Types.Armour, uvs : List Knight.UV.UV }"},"Knight.Types.Armour":{"args":[],"type":"{ id : String , name : String , hearts : Int , defences : List ( Knight.UV.DamageType, Float ) , resistances : List ( Knight.Status.Status, Float ) , bonuses : List ( Knight.UV.Bonus, Knight.UV.BonusStrength ) }"},"Knight.Types.Shield":{"args":[],"type":"{ id : String, name : String, effects : List Knight.UV.UV }"},"Knight.ShieldEquip":{"args":[],"type":"{ piece : Knight.Types.Shield, uvs : List Knight.UV.UV }"},"Knight.Knight":{"args":[],"type":"{ name : String , weapons : List Knight.WeaponEquip , helmet : Knight.ArmourEquip , armour : Knight.ArmourEquip , shield : Knight.ShieldEquip , trinkets : List Knight.Types.Trinket , vita : Int }"},"Knight.Types.Weapon":{"args":[],"type":"{ id : String , name : String , weaponType : Knight.Types.WeaponType , damageType : Knight.UV.DamageType , chargeTime : Float , split : Maybe.Maybe Knight.UV.DamageType , status : Maybe.Maybe Knight.Status.Status , attacks : List ( Knight.Types.Stage, Float ) , inflictions : List ( Knight.Types.Stage , Knight.Types.StatusChance , Knight.Types.StatusStrength ) , bonuses : List ( Knight.UV.Bonus, Knight.UV.BonusStrength ) }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
...
var runElmProgram = Elm.Main.fullscreen;